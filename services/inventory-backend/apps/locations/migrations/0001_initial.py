    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True, db_index=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("provider_requested", models.CharField(default="internal", max_length=50)),
                (
                    "status",
                    models.CharField(
                        choices=[
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["facility", "starts_on", "ends_on"],
                        name="fac_lifecycle_window_idx",
                    )
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["facility", "system", "identifier_type"],
                        name="fac_addid_lookup_idx",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("result_message", models.CharField(blank=True, max_length=255)),
                ("result_payload", models.JSONField(blank=True, default=dict)),
                ("external_cost_estimate", models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True)),
                ("history_id", models.AutoField(primary_key=True, serialize=False)),
                ("history_date", models.DateTimeField(db_index=True)),
                ("history_change_reason", models.CharField(max_length=100, null=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parent",
                    models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name="+", to="locations.facility"),
                ),
                (
                    "updated_by",
                    models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name="+", to=settings.AUTH_USER_MODEL),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "organization",
                    models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name="+", to="organization.organization"),
                ),
                (
                    "updated_by",
                    models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name="+", to=settings.AUTH_USER_MODEL),
