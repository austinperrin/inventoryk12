...
class Address(BaseModel, AuditModel):
    ...
    def __str__(self) -> str:
        if self.formatted_single_line:
            return self.formatted_single_line
        return ", ".join(part for part in [self.line_1, self.city] if part)
...
class AddressValidationRun(BaseModel, AuditModel):
    ...
    provider_requested = models.CharField(max_length=50, default="internal")
