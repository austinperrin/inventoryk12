...
INSTRUCTION_CODE_TABLE_SEEDS = (
    ("SubjectCode", SubjectCode, SUBJECT_CODE_SEEDS),
    ("GradeLevelCode", GradeLevelCode, GRADE_LEVEL_CODE_SEEDS),
)


class Command(BaseCommand):
    help = "Seed baseline system-managed instruction code-table values."
    ...
    def handle(self, *args, **options) -> None:
        ...
        with transaction.atomic():
            for model_name, model, rows in INSTRUCTION_CODE_TABLE_SEEDS:
