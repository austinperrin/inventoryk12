...
ENROLLMENT_CODE_TABLE_SEEDS = (
    ("EnrollmentEntryCode", EnrollmentEntryCode, ENROLLMENT_ENTRY_CODE_SEEDS),
    ("EnrollmentExitCode", EnrollmentExitCode, ENROLLMENT_EXIT_CODE_SEEDS),
    ("StaffAssignmentRoleCode", StaffAssignmentRoleCode, STAFF_ASSIGNMENT_ROLE_CODE_SEEDS),
)


class Command(BaseCommand):
    help = "Seed baseline system-managed enrollment code-table values."
    ...
    def handle(self, *args, **options) -> None:
        ...
        with transaction.atomic():
            for model_name, model, rows in ENROLLMENT_CODE_TABLE_SEEDS:
